...
export default function DateTimePicker({
    ...
    }, [formData.day, formData.year, formData.hour, formData.month, formData.minute]);
    ...
    function minutePicker() {
        const minute: string[] = ['00', '05', '10', '15', '20', '25', '30', '35', '40', '45', '50', '55'];
        let html = [];
    ...
    function getCurrentTime(): DateAndTime {
        ...
        return {
            ...
            hour: hour,
            minute: minute,
            date: new Date(`${year}-${monthToNumber(month)}-${day}T${hour}:${minute}:00`),
        };
    }
    ...
    function formDataToDateObject() {
        ...
        const date = new Date(`${year}-${monthToNumber(month)}-${day}T${hour}:${minute}:00`);
        return date;
    }
